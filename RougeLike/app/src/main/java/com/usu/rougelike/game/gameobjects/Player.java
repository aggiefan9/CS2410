...
public class Player extends GameObject {
    ...
    public void render(Canvas canvas, Paint paint) {
        ...
        canvas.drawCircle(cellSize / 2, cellSize / 6, cellSize / 6, paint);
        canvas.drawRoundRect(cellSize / 3, cellSize / 3, cellSize  * 2 / 3, (cellSize * 2 / 3) + 10, 15, 15, paint);
        canvas.drawRect((cellSize / 3), (cellSize * 2 / 3), (cellSize / 3) + 20, cellSize, paint);
        canvas.drawRect((cellSize * 2 / 3), (cellSize * 2 / 3), (cellSize * 2 / 3) - 20, cellSize, paint);
    }
}

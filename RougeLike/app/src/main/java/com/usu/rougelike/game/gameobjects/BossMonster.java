...
public class BossMonster extends GameObject {
    ...
    public void render(Canvas canvas, Paint paint) {
        ...
        if (alive) {
            ...
            //canvas.drawRect(cellSize / 4, 10, cellSize * 3 / 4, cellSize * 2 / 3, paint);
            canvas.drawCircle(cellSize / 2, cellSize / 2 - 20, 50, paint);
            canvas.drawRect(cellSize / 4 + 15, cellSize * 2 / 3, cellSize / 4 + 30, cellSize, paint);
            canvas.drawRect(cellSize * 3 / 4 - 30, cellSize * 2 / 3, cellSize * 3 / 4 - 15, cellSize, paint);
            paint.setColor(Color.WHITE);
            canvas.drawCircle(cellSize / 3 + 10, 40, 10, paint);
            canvas.drawCircle(cellSize * 2 / 3 - 10, 40, 10, paint);
            canvas.drawRect(cellSize / 3, cellSize / 2 - 7, cellSize * 2 / 3, cellSize / 2, paint);
            paint.setColor(Color.BLACK);
            paint.setStyle(Paint.Style.STROKE);
            paint.setStrokeWidth(2);
            canvas.drawCircle(cellSize / 3 + 10, 40, 10, paint);
            canvas.drawCircle(cellSize * 2 / 3 - 10, 40, 10, paint);
            canvas.drawCircle(cellSize / 3 + 10, 40, 1, paint);
            canvas.drawCircle(cellSize * 2 / 3 - 10, 40, 1, paint);
            canvas.drawRect(cellSize / 3, cellSize / 2 - 7, cellSize * 2 / 3, cellSize / 2, paint);
        } else {
            paint.setColor(Color.CYAN);
            canvas.drawRect(0,cellSize - 20, cellSize, cellSize, paint);
            paint.setColor(Color.MAGENTA);
            canvas.drawRoundRect(cellSize / 2, cellSize * 2 / 3, cellSize - 10, cellSize - 10, 50, 50, paint);
            canvas.drawRect(cellSize / 4, cellSize * 3 / 4 + 10, cellSize * 2 / 3, cellSize - 15, paint);
            paint.setColor(Color.BLACK);
            canvas.drawCircle(cellSize - 25, cellSize * 2 / 3 + 5, 5, paint);
        }    }
}
